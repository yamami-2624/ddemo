...
public class FriendDatabaseAdapter {
    static final private String DBNAME = "friend.sqlite";
    private final static String DB_TABLE = "friend";       // DBのテーブル名
    ...
    private FriendDatabaseHelper helper = null;           // DBHepler
    protected Context context;                  // Context

    // コンストラクタ
    public FriendDatabaseAdapter(Context context) {
        this.context = context;
        helper = new FriendDatabaseHelper(this.context);
    }
     ...
     */
    public FriendDatabaseAdapter openDB() {
     ...
     * @return this 自身のオブジェクト
     */
    public FriendDatabaseAdapter readDB() {
